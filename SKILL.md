...
### 规则1：先问再下载（流程）
收到链接/BV号/短链：
1. **先提供在线预览直链**（**必须是完整 URL，带 `https://` 协议头和完整域名，禁止省略写成 `mbplayer.html?...` 之类的相对路径**——省略协议头无法点击）：
```
